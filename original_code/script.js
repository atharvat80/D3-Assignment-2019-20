...
function init() {
    ...
    path = d3.geoPath()
     ...
     // load up data
       d3.queue()
        .defer(d3.json, "https://raw.githubusercontent.com/atharvat80/D3_Assignment/master/wpc.json?token=AMFZ23ZENO6KXOBAO6G7J7K57C6CQ")
        .defer(d3.csv, "https://raw.githubusercontent.com/atharvat80/D3_Assignment/master/mp_data.csv?token=AMFZ235UONIWYAAU5NC3OWC57C55A")
